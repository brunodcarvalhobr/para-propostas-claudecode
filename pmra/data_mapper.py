...
def form_to_context(form: ProposalForm) -> dict[str, Any]:
    ...
    return {
        ...
        "consultiva": {
            ...
            "tabela_senioridade": [s.model_dump() for s in form.honorarios_consultiva.tabela_senioridade],
            "hora_fixa_valor": form.honorarios_consultiva.hora_fixa_valor,
            "fixo_mensal_valor": form.honorarios_consultiva.fixo_mensal_valor,
            "fixo_mensal_cap": form.honorarios_consultiva.fixo_mensal_cap,
            "fixo_mensal_excedente": form.honorarios_consultiva.fixo_mensal_excedente,
            "valor_projeto_total": form.honorarios_consultiva.valor_projeto_total,
        ...
        "contenciosa": {
            ...
            "tabela_acoes": [a.model_dump() for a in form.honorarios_contenciosa.tabela_acoes],
            "tabela_atos": [a.model_dump() for a in form.honorarios_contenciosa.tabela_atos],
            "preco_mensal_valor": form.honorarios_contenciosa.preco_mensal_valor,
            ...
            "valor_projeto_total": form.honorarios_contenciosa.valor_projeto_total,
