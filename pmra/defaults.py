...
DESPESAS_GERAIS_DEFAULT = (
    "Deslocamento em veículo próprio: R$ 2,50 por km e estacionamento, táxi, "
    "transporte por aplicativo, hospedagem e alimentação."
)

DESPESAS_ESPECIFICAS_DEFAULT = (
    "Custas e emolumentos judiciais e administrativos, depósitos recursais, "
    "diligências externas simples (R$ 150,00 por diligência), serviços de "
    "correspondentes e demais despesas correlatas, apurados conforme necessidade."
)
...
def proposal_form_default() -> ProposalForm:
    return ProposalForm(
        ...
        despesas=Despesas(
            gerais_descricao=DESPESAS_GERAIS_DEFAULT,
            especificas_descricao=DESPESAS_ESPECIFICAS_DEFAULT,
        ),
